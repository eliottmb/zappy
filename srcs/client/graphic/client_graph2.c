/*
** client_graph2.c for y in /home/goepfe_a/graphic
** 
** Made by alexandre goepfert
** Login   <goepfe_a@epitech.net>
** 
** Started on  Sun Jul  2 18:57:21 2017 alexandre goepfert
** Last update Sun Jul  2 18:59:24 2017 alexandre goepfert
*/
...
void    add_player(t_bmp *struc, char **buffer)
{
  if(struc->inf.us == NULL)
    struc->inf.us = create_node(atoi(buffer[2]), atoi(buffer[3]), atoi(buffer[1]), buffer[4]);
  else
